...
_SYSTEM_PROMPT = (
    ...
    "- Coverage inflation: coverage appears adequate but critical logic paths lack real assertions\n"
    "- Missing behavioral testing: production logic was changed but tests only cover it indirectly or not at all\n"
    "- Mock overuse: too many dependencies are mocked, tests do not validate real system behavior\n"
